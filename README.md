...
<html>
  <head>
    ...
    <body bgcolor="pink">
      ...
      <div class="con">
        ...
        <img src="biriyani_pa-removebg-preview.png" alt="Image" width="250" height="250">
        <h1>Epicurean Biriyani</h1>
      ...
      <div class="cd">
        <nav>
         <ul>
          ...
          <a href="administartion.html" style="color:white"><li>administartion  |</li></a>
          <a href="contacts us.html" style="color: white;"><li>contact us    </li></a>
         </ul>
       </nav>
      </div>
    </center>
  ...
  <div class="container">
          <div class="box">
            <h2>Our New Menu</h2>
            <img src="food menu.jpg" height="300x" width="350x" alt="img">
          ...
          <div class="box">
            <h2>Book A Table</h2>
            <img src="boo table.jpg" height="300x" width="350x" alt="img">
          ...
          <div class="box">
            <h2>Opening Hours</h2>
            <img src="opening close.jpg" height="300x" width="350x" alt="imf">
  ...
  <div class="exit">
    <hr>
    <img src="biriyani_pa-removebg-preview.png" height="150px" width="150px">
</div>
<br>
<br>
<center>
  <p>Designed and developed by<span class="highlight"> Vignesh</span>.</p>
</center>
    </body>
    ...
    <style>
        * {
        ...
        .items1{
            width: 300px;
            height: 300px; 
            background-image:url(balaji\ phot.jpg); 
            background-size:cover; 
            background-position: center; 
            border-radius: 10px;
            display: flex;
        ...
        .items4{
            width: 300px;
            height: 300px; 
            background-image:url(munusamy.jpg); 
            background-size:cover; 
            background-position: center; 
            border-radius: 10px;
            display: flex;
        ...
        .items6{
            width: 300px;
            height: 300px; 
            background-image:url(gowtham.phto.jpg); 
            background-size:cover; 
            background-position: center; 
            border-radius: 10px;
            display: flex;
...
<body>
    ...
    <div class="menus">
        ...
        <div class="words">
            <h2 class="order">Mr.Hariharan</h2>
    ...
    <div class="menus">
        ...
        <div class="words">
            <h2 class="order1">Mr.Kamalesh</h2>
        </div>
    </div>
    <div class="menus">
        <div class="items5">
    ...
    * {
    ...
    <div class="ender">
        ...
        <div class="location3">
            ...
            <h3 class="iden"> @Epicureanbiriyani</h3>
            <br>
            <h3 class="iden">X :</h3>
            <h3 class="iden">@Epicureanbiriyani </h3>
            <br>
    ...
    <div class="details">
        <ul class="details-ul">
            <li class="details-ul"><b> 📞</b> : +91 9363744498,</li>
            <li  class="details-ul"></li>
            <li  class="details-ul"></li>
            <li class="details-ul"><b> 📧 </b> : Epicureanbriyani@gmail.com</li> 
        </ul>
    </div>
    <br><br><br><br><br><br>
    <footer>
        ...
        <br><br>
        <h2> Copyright &copy; 2024 Epicurean Briyani </h2>
        <h2>Designed and Developed By <span>  Vignesh V</span></h2>
    </footer>
</body>
